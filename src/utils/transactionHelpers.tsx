...
/**
 * ParsedTransaction type — shared between parsers and Firestore import
 */
...
/**
 * Helper to build a natural key for deduplication
 */
...
/**
 * Bulk import transactions for a client
 * - Dedupes based on natural key
 * - Overwrites unverified transactions
 * - Skips verified/rejected transactions
 */
